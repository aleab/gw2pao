...
namespace GW2PAO.API.Data.Enums
{
    ...
    public static class WvWObjectiveIds
    {
        ...
        public static readonly WvWObjectiveId EB_Mercenary_Molevekian = new WvWObjectiveId(123, WvWMap.EternalBattlegrounds);
        public static readonly WvWObjectiveId EB_Mercenary_Orgath     = new WvWObjectiveId(125, WvWMap.EternalBattlegrounds);
        public static readonly WvWObjectiveId EB_Mercenary_Darkrait   = new WvWObjectiveId(126, WvWMap.EternalBattlegrounds);
        public static readonly WvWObjectiveId EB_Spawn_Hill_Red       = new WvWObjectiveId(124, WvWMap.EternalBattlegrounds);
